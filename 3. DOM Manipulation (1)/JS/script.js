...
let github_link = first_section.querySelectorAll("p")[1];
github_link.setAttribute(
  "style",
  "text-align: center; background-color: #0f0f0f;"
);
let github_link_a_tag = github_link.querySelector("a");
github_link_a_tag.setAttribute("style", "color: #f4f4f4; border: none");
